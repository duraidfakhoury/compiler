...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		ASSIGN=24, PLUS=25, MINUS=26, MULT=27, DIVID=28, DOUBLE_ASSIGN=29, NOT_EQUAL=30, 
		DOUBLE_ASSIGN_ID=31, LBRACE=32, RBRACE=33, LBRACKET=34, RBRACKET=35, COLON=36, 
		COMMA=37, SEMICOLON=38, DOT=39, WHITESPACE=40, COMMENT=41, LPAREN=42, 
		RPAREN=43, LTAG=44, RTAG=45, SLASH=46, PLUSPLUS=47, MINUSMINUS=48, QMARK=49, 
		EMARK=50, DOUBLE_QMARK=51, OR=52, AND=53, BACKTICK=54, LTAG_HTML=55, LBRACE_HTML=56, 
		RBRACE_HTML=57, BACKTICK_HTML=58, TEXT_HTML=59, WS=60, DIV=61, P=62, H1=63, 
		H2=64, H3=65, H4=66, H5=67, H6=68, BUTTON=69, SPAN=70, A=71, IMG=72, INPUT=73, 
		FORM=74;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'div'", "'p'", "'h1'", "'h2'", "'h3'", "'h4'", "'h5'", "'h6'", "'button'", 
			"'span'", "'a'", "'img'", "'input'", "'form'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ASSIGN", "PLUS", "MINUS", "MULT", "DIVID", "DOUBLE_ASSIGN", "NOT_EQUAL", 
			"DOUBLE_ASSIGN_ID", "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", "COLON", 
			"COMMA", "SEMICOLON", "DOT", "WHITESPACE", "COMMENT", "LPAREN", "RPAREN", 
			"LTAG", "RTAG", "SLASH", "PLUSPLUS", "MINUSMINUS", "QMARK", "EMARK", 
			"DOUBLE_QMARK", "OR", "AND", "BACKTICK", "LTAG_HTML", "LBRACE_HTML", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 991236210928471550L) != 0) );
			}
		}
	...
	public final IterationStatementContext iterationStatement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 306671475381764096L) != 0)) {
					{
					setState(194);
	...
	public final PrimaryValueContext primaryValue() throws RecognitionException {
		...
		try {
			...
			case 12:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 684564735546359808L) != 0)) {
					{
					{
					setState(454);
	...
	public final HtmlElementNameContext htmlElementName() throws RecognitionException {
		...
		try {
			...
			setState(555);
			_la = _input.LA(1);
			if ( !(((((_la - 21)) & ~0x3f) == 0 && ((1L << (_la - 21)) & 18013298997854209L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
